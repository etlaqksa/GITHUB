      ...
      <nav className="container flex h-20 items-center justify-between gap-2 min-w-0">
        ...
        <LocalizedLink href="/">
          <div className="flex items-center space-x-2 rtl:space-x-reverse cursor-pointer hover:scale-105 transition-transform duration-300">
            <img src="/logo-140.webp?v=6" srcSet="/logo-140.webp?v=6 140w, /logo-280.webp?v=6 280w" sizes="140px" width="140" height="70" alt="شركة إطلاق المتميزة" className="h-10 sm:h-12 w-auto object-contain hover-brightness" loading="eager" decoding="async" />
          </div>
        </LocalizedLink>
