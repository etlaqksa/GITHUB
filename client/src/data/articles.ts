...
export const articles: ArticleContent[] = [
  ...
  **Implementation Steps:**
  ...
  1. **Cavity Detection:** Using Ground Penetrating Radar (GPR), Electrical Resistivity, or Seismic surveys.  
  ...
  **Standards:**  
  ...
  5) **تحقق (Verification)**: في المشاريع عالية المخاطر، نربط النتائج بحفر Cavity Probing/اختبارات للتحقق قبل المعالجة.
