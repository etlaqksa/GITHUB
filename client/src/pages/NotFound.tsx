        ...
        <CardContent className="p-6 sm:p-10">
          <div className="flex items-center justify-between gap-4 mb-6">
            <div className="flex items-center gap-3">
              <img src="/logo-140.webp?v=6" srcSet="/logo-140.webp?v=6 140w, /logo-280.webp?v=6 280w" sizes="140px" width="140" height="70" alt="ETLAQ" className="h-10 w-auto" loading="eager" decoding="async" />
